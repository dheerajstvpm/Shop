...
router.post(
  ...
  adminController.addNewAdminPost,
);
...
router.post(
  ...
  check("maxDiscount")
    .notEmpty()
    .withMessage("Please enter a maximum discount"),
...
router.get(
  "/allOrderManagement/:page",
  adminController.adminAllOrderManagementGet,
);

router.get(
  "/datatableOrderManagement",
  adminController.adminDatatableOrderManagementGet,
);
...
router.post(
  "/adminAllOrderUpdate/:unique",
  adminController.adminAllOrderUpdate,
);

router.post(
  "/adminCategoryOfferUpdate/:category",
  adminController.adminCategoryOfferUpdate,
);
...
router.post(
  "/addNewCoupon/",
  check("coupon").notEmpty().withMessage("Please enter a name"),
  check("reduction").notEmpty().withMessage("Please enter a valid number"),
  check("reduction").matches(/\d/).withMessage("Please enter a valid number"),
  check("minOrder").notEmpty().withMessage("Please enter a valid number"),
  check("minOrder").matches(/\d/).withMessage("Please enter a valid number"),
